...
FAVORITE_PRODUCT_PAGE_SIZE = 8

FAVORITE_SHOP_PAGE_SIZE = 8

SHOP_PRODUCT_PAGE_SIZE = 16

SHOP_BANNER_PAGE_SIZE = 8

FEATURED_SHOP_PAGE_SIZE = 4

RECOMMENDED_SHOP_PAGE_SIZE = 4

REVIEW_PAGE_SIZE = 5

PURCHASE_PAGE_SIZE = 3
